...
const ProductDetailModal = () => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 w-screen h-screen bg-black bg-opacity-80 flex justify-center items-center px-2 md:px-0 ${
        showProductDetail ? "scale-100" : "scale-0"
      }`}
    >
      <div
        ...
        } rounded-lg bg-base-100 w-[500px] h-[300px] max-md:w-[90%] transition duration-300 ${
          showProductDetail ? "scale-100" : "scale-0"
        }`}
      >
